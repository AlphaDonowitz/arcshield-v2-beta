...
window.currentDecimals = 18;
window.uploadedLogoData = null;

// ARC TESTNET
window.ARC_CHAIN_ID = '0x4c9a62'; // 5042002
...
window.CCTP_CONFIG = {
    sepolia: {
        chainId: '0xaa36a7', rpc: 'https://rpc.sepolia.org', domainId: 0, 
        usdc: "0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238", 
        tokenMessenger: "0xBd3fa81B58Ba92a82136038B25aDec7066af3155", 
        messageTransmitter: "0x7865f4c4f164ea385d3b428b234c2489e59656c6"
    },
    arc: {
        chainId: '0x4c9a62', domainId: 26, 
...
// ABIS (Minificados para economizar espaço visual)
window.ABIS = { 
...
try {
    if (window.supabase) {
        ...
        console.log("✅ Config: Supabase Iniciado.");
    }
} catch(e) { console.log("⚠️ Config: Supabase Offline"); }